...
public final class Config {
	...
	public static final int FIX_ELEVATOR_TIME = 5000;
	public static final int TIMER_TIMEOUT = 20000;
	...
	public static final UDPInfo[] ELEVATORS_UDP_INFO = { new UDPInfo(host1InetAddress, 5002, 5003),
			new UDPInfo(host1InetAddress, 5004, 5005), new UDPInfo(host1InetAddress, 5006, 5007), };

	public static final UDPInfo[] FLOORS_UDP_INFO = { new UDPInfo(host1InetAddress, 5008, 5009),
			new UDPInfo(host1InetAddress, 5010, 5011), new UDPInfo(host1InetAddress, 5012, 5013),
	...
	public static final Pair[] faults = { new Pair(15, 1), new Pair(30, 2), new Pair(45, 1) };
	// ------------------------------------------------------------------------------------------------
