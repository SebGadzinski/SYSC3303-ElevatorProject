...
public final class Config {
    ...
    public static final UDPInfo[] ELEVATORS_UDP_INFO = {new UDPInfo(5002, 5003), new UDPInfo(5004, 5005), new UDPInfo(5006, 5007), new UDPInfo(5008, 5009)};
    public static final UDPInfo[] FLOORS_UDP_INFO = {new UDPInfo(5008, 5009), new UDPInfo(5010, 5011), new UDPInfo(5012, 5013), new UDPInfo(5014, 5015)};
